...
In this blog post, I want to practice some EDA and Visualizations in R. I've taken a dataset from [Kaggle](https://www.kaggle.com/) on [Superheroes](https://www.kaggle.com/claudiodavi/superhero-set/data). It consists of two parts, one containing demographic type of information and another with a list of super powers of the superheroes. Diving right into the data.
